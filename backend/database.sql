-- Initial database setup for WeighBridge System
...
('RKD – Shela Nagar'),
('Afcyan – Shela Ngr'),
('Bharath Verma – Airport'),
('Aparna RMC – Gajuwaka'),
('ACC RMC – Gajuwaka'),
('Prisam RMC – Gajuwaka'),
('Nuvoco RMC – Gajuwaka'),
('Ultratech – Mindi'),
('MK Builders – Madhurwada'),
('North Star Homes – Madhurwada'),
('Coastal RMC – Madhurwada'),
('Coastal RMC – Achututapuram'),
